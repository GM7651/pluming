...
<div id="contact" className="flex flex-col justify-center items-center w-full h-full bg-white px-4 sm:px-6 lg:px-20">
  ...
  <div className="my-2 w-full sm:w-1/2 lg:w-1/4">
    ...
    <div 
    className="w-full sm:w-10/12 md:w-8/12 lg:w-6/12 xl:w-4/12 px-4 sm:px-6 md:px-8 py-6 sm:py-8 md:py-10 mt-4 sm:mt-6 lg:mt-0 shadow-xl bg-red-600 text-white rounded-2xl">
